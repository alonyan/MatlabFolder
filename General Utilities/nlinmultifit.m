function [beta,r,J,Sigma,mse] = nlinmultifit(x_cell, y_cell, mdl_cell, beta0, options)
...
%
	...
	if nargin == 4
		[beta,r,J,Sigma,mse] = nlinfit(x_vec, y_vec, mdl_vec, beta0);
	else
		[beta,r,J,Sigma,mse] = nlinfit(x_vec, y_vec, mdl_vec, beta0, options);
	end
end
