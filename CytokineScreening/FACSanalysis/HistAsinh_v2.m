function [procData, LinearRange] = HistAsinh_v2(Data, varargin)
...
% [proc_ExposedToIL2_5CC7, LinearRange] = HistAsinh_v2(ExposedToIL2_5CC7,'Tag', 'PE','Tag', 'APC','Tag', 'You're it!');
    ...
    elseif length(j1)==1,
        ...
        elseif isstruct(Data)&isfield(Data, 'data'), % data as loaded by LoadFACSfromFlowJoWorkspace_v2 function                
                    TagData = GetFACSdataFromMatLabStructByTag_v2(Data, varargin{:})
                    tempData = [];
...
%         end;
        ...
        for I = 1:length(TagData(1).Tags)
            Tag = TagData(1).Tags(I)
     ...
     %   clear H Hnorm meanD medianD geomeanD CVD cellNo;
