function [P, Plin, B, I] = ScreenedFieldToDistributionFIDAfast_v1(beta, X, varargin)
...
%%options.BG.BETA(2) peak of first(big) gaussian
...
if options.BG.do
    I = I.*NGaussianfft_v1(options.BG.BETA,x,Qtag);
end;
