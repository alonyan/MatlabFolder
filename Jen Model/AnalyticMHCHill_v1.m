function y = AnalyticMHCHill_v1(param,t)
...
y = ((l*k*pSTAT1_ss_sc/(pSTAT1_ss_sc+Kd))/(beta2-beta1)).*((-exp(-beta1*t))/beta1+(exp(-beta2*t))/beta2+((beta2-beta1))/(beta1*beta2)); %protein
