function [gamma, TSPAN]=CompactModelGamma(parameters)
...
EndParam = [EndParam; 0 X(end,2:3)];


EndParam = EndParam./parameters.nA;

%EndParam(1) = IFNgR;
gamma = [gamma; X(:,1)'];

TSPAN2 = 18050:50:6e5;   %Timespan of model run
