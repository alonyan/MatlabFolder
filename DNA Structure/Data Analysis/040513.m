...
%'Specify group, and gate for WT'
pause
[CGData_WT CompensationMatrix WorkSp groupInd gateInd] = LoadFACSfromFlowJoWorkspace_v4( fpath,'Group',4,'gate',2); %CFSE

'Specify group, and gate for KO'
[CGData_KO CompensationMatrix WorkSp groupInd gateInd] = LoadFACSfromFlowJoWorkspace_v4( fpath,'Group',4,'gate',3); %CTV
