...
clear ;
filepath = ['\\eligal-lior\g$\Experiments\Scanning_FCS_MSD\All_Experiments\011208\round1\'];
filehead = 'L6o25_v';
...
%filehead = 'L24_V';
 %NormRange = [1e-3 3e-3];
%%
 S = LoadMultipleCorrFunc_v2(filepath, {'Pik2_PR_PBS_vv 1p28_1'}, 'Rejection', Rejection, 'DeleteList', []);
%%
