...
nametemplate = 'L18KNOSALT_Dbl_St';
%dataname = 'calib1';
...
%%
files = dir([filepath nametemplate '4468*']);
DynamicName = {files.name}%dynamic
Dyn = LoadMultipleCorrFunc_v3(filepath, DynamicName , 'Rejection', 50, 'NormalizationRange', [1e-3 2e-3],  'DeleteList', []);
