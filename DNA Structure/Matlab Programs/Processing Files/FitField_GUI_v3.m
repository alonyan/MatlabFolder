function FigHdl = FitField_GUI_v3(B, minVt, dynRange, showRange, lowestG, wSq, NormRange)
beta = [];
pGauss= [];
...
FitCB1Hdl = uicontrol('Parent', Panel1Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', FitCBRect);
WxyET1Hdl = uicontrol('Parent', Panel1Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect);
PlotSlowCB1Hdl = uicontrol('Parent', Panel1Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', PlotSlowCBRect);
ZcorrCB1Hdl = uicontrol('Parent', Panel1Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', ZcorrCBRect);
NormRangeET1Hdl = uicontrol('Parent', Panel1Hdl, 'Style','edit','String', num2str(NormRange), 'Units', 'normalized', 'Position', NormRangeETRect);

Panel2Hdl = uipanel(FigHdl, 'Units', 'normalized', 'Position', Panel1Rect + [0  -0.05  0 0] );
ShowCB2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect);
SlowET2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','edit','String', '2', 'Units', 'normalized', 'Position', SlowETRect);
FastET2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','edit','String', num2str(TotalSpeeds-1), 'Units', 'normalized', 'Position', FastETRect);
FitCB2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', FitCBRect);
WxyET2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect);
PlotSlowCB2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', PlotSlowCBRect);
ZcorrCB2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', ZcorrCBRect);
NormRangeET2Hdl = uicontrol('Parent', Panel2Hdl, 'Style','edit','String', num2str(NormRange), 'Units', 'normalized', 'Position', NormRangeETRect);

Panel3Hdl = uipanel(FigHdl, 'Units', 'normalized', 'Position', Panel1Rect + [0  -0.1  0 0] );
ShowCB3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect);
SlowET3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','edit','String', '3', 'Units', 'normalized', 'Position', SlowETRect);
FastET3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','edit','String', num2str(TotalSpeeds-2), 'Units', 'normalized', 'Position', FastETRect);
FitCB3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', FitCBRect);
WxyET3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect);
PlotSlowCB3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', PlotSlowCBRect);
ZcorrCB3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','checkbox', 'Value', 0, 'Units', 'normalized', 'Position', ZcorrCBRect);
NormRangeET3Hdl = uicontrol('Parent', Panel3Hdl, 'Style','edit','String', num2str(NormRange), 'Units', 'normalized', 'Position', NormRangeETRect);
...
Fit1CB4Hdl = uicontrol('Parent', Panel4Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect+ [0.1 0 0 0]);
...
Fit2CB4Hdl = uicontrol('Parent', Panel4Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect+ [0.5 0 0 0]);
...
Panel5Hdl = uipanel(FigHdl, 'Units', 'normalized', 'Position', Panel1Rect + [0  -0.25  0 0] );
NoST5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','text', 'String', '2)', 'Units', 'normalized', 'Position', NoSTRect);
Fit1CB5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect+ [0.1 0 0 0]);
W1_ST5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect - [0.2 0 0 0]);
S1_ST5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect - [0.05 0 0 0]);
Fit2CB5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect+ [0.5 0 0 0]);
W2_ST5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect + [0.2 0 0 0]);
S2_ST5Hdl = uicontrol('Parent', Panel5Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect + [0.35 0 0 0]);

Panel6Hdl = uipanel(FigHdl, 'Units', 'normalized', 'Position', Panel1Rect + [0  -0.3  0 0] );
NoST6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','text', 'String', '3)', 'Units', 'normalized', 'Position', NoSTRect);
Fit1CB6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect+ [0.1 0 0 0]);
W1_ST6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect - [0.2 0 0 0]);
S1_ST6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect - [0.05 0 0 0]);
Fit2CB6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','checkbox', 'Value', 1, 'Units', 'normalized', 'Position', ShowCBRect+ [0.5 0 0 0]);
W2_ST6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect + [0.2 0 0 0]);
S2_ST6Hdl = uicontrol('Parent', Panel6Hdl, 'Style','text','String', '__', 'Units', 'normalized', 'Position', WxyETRect + [0.35 0 0 0]);
...
%StopPBHdl = uicontrol('Parent', FigHdl, 'Style','pushbutton','String', 'Stop', 'Units', 'normalized', 'Position', [0.35 0.93 0.1 0.05], 'Callback', {@StopPBHcallback});
    ...
    function fieldAr = PlotFitRoutine
        function field = CalculateField(slow, fast, plotTag, fitTags, paramHandles, colorStr, plotSlowTag, ZcorrTag, NR)
            ...
            Gfast = B.ReNormalized(:, fast)/robmean(B.ReNormalized(j1, fast), B.errorNormalized(j1, fast));
            Gslow = B.ReNormalized(:, slow)/robmean(B.ReNormalized(j1, slow), B.errorNormalized(j1, slow));
            NofMultipleGauss = 9;
           ...
           j4 = intersect(j4, j3);
            ...
            if plotSlowTag,
                semilogy(field.r([field.J_fit field.J_show]).^2, B.ReNormalized([field.J_fit field.J_show], slow), ['--' colorStr]);
            end;
        ...
        fieldAr(1) = CalculateField(str2num(get(SlowET1Hdl, 'String')), str2num(get(FastET1Hdl, 'String')), get(ShowCB1Hdl, 'Value'), fitTags, paramHandles, 'b', get(PlotSlowCB1Hdl, 'Value'), get(ZcorrCB1Hdl, 'Value'), str2num(get(NormRangeET1Hdl, 'String')));

        fitTags = [get(FitCB2Hdl, 'Value') get(Fit1CB5Hdl, 'Value') get(Fit2CB5Hdl, 'Value')];
        paramHandles = [WxyET2Hdl W1_ST5Hdl S1_ST5Hdl W2_ST5Hdl S2_ST5Hdl];
        fieldAr(2) = CalculateField(str2num(get(SlowET2Hdl, 'String')), str2num(get(FastET2Hdl, 'String')), get(ShowCB2Hdl, 'Value'), fitTags, paramHandles, 'g', get(PlotSlowCB2Hdl, 'Value'), get(ZcorrCB2Hdl, 'Value'), str2num(get(NormRangeET2Hdl, 'String')));

        fitTags = [get(FitCB3Hdl, 'Value') get(Fit1CB6Hdl, 'Value') get(Fit2CB6Hdl, 'Value')];
        paramHandles = [WxyET3Hdl W1_ST6Hdl S1_ST6Hdl W2_ST6Hdl S2_ST6Hdl];
        fieldAr(3) = CalculateField(str2num(get(SlowET3Hdl, 'String')), str2num(get(FastET3Hdl, 'String')), get(ShowCB3Hdl, 'Value'), fitTags, paramHandles, 'r', get(PlotSlowCB3Hdl, 'Value'), get(ZcorrCB3Hdl, 'Value'), str2num(get(NormRangeET3Hdl, 'String')));
