...
close all
NormRange = [1e-3 2e-3];
filepath = 'G:\Ilan\Experiments\300709\';

%% ref file name
blank_fname_ref={ 'his_egfp_015mkM' };
blankRef = LoadMultipleCorrFunc_v2(filepath,  blank_fname_ref, 'Rejection',2, 'NormalizationRange', NormRange,  'DeleteList', []);
...
%% Blank file name
blank_fname_In ={ 'mind_300_inside_corr_7' };
blankIn = LoadMultipleCorrFunc_v2(filepath,  blank_fname_In, 'Rejection',0.5, 'NormalizationRange', NormRange,  'DeleteList', []);
[p, q] = sort(blankIn.score, 'descend')
...
%% Outside vesicle
blank_fname_Out ={'mind_300_outside_corr_7' };
...
%% Sample
sample_fname = {'mind_300_corr_7'}%dynamic
...
S.membrG0 = membr.G0;
S.RefG0=RefG0;
S.oligomerFromAmplRef= S.membrG0 /S.RefG0;
S.Nmolecules_on_membr = membr.countrateGood/membr.G0;
S.molecules_per_umSq = S.Nmolecules_on_membr/(pi*0.25^2) ;
eval([struc_name '=S'])


%% Open and Show liposom image
scan_fname='300xy10';  %% whiout the .mat%%
ShowSaveImage=OpenAndSaveLVimage(filepath, scan_fname) ;
