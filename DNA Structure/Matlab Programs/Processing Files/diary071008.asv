...
B1 = guidata(FigHdl);
close(FigHdl);
data061008_proc0710.field500.wS = B1.field.paramGauss(2)
b = 0.1;
L = 1.5*500*0.34e-3
Rg = sqrt(L*b/6 -b^2/4 + b^3./(4*L) - b^4./(8*L.^2).*(1 - exp(-2*L/b)))
data061008_proc0710.field500.wXY = sqrt(data061008_proc0710.field500.wS^2 - 2/3*Rg^2)
%%
...
for i=1:length(fnamesData),
    ...
    S.errorSq = sqrt((S.errorFq./S.fq_int).^2 +(data061008_proc0710.field500.errorFq./data061008_proc0710.field500.fq_int).^2).*S.Sq_int;
