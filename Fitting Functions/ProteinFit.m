%% MHC Fitting function

function y = ProteinFit(alpha, t)
...
y = alpha*(1/(beta1*(beta1-beta2)).*(exp(-beta1*t))-1/(beta2*(beta1-beta2)).*(exp(-beta2*t)))+(alpha+l*c)/(beta1*beta2); %protein
