classdef MultiColorSPIMTimepoint
    ...
    methods
        ...
        function h= scatter3(W,varargin)
            ...
            set(gca,'CameraPositionMode','manual','CameraPosition', [1.0674   -0.6095   -0.0321]*1e+04...
                ,'color','k', 'xcolor','none', 'ycolor','none', 'zcolor','none','xgrid', 'off','ygrid', 'off','zgrid', 'off')
            set(gcf,'color','k')
            set(gca,'xlim',[[0 1500]],'ylim',[0 1200],'zlim',[-1800 0])
            hold on
            %shg
