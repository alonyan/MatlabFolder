classdef MulticolorSPIMResults < Results
    ...
    methods
        ...
        function R = reload(R,S)
            ...
            if isfield(S,'SPIMTimepoints') 
                R.SPIMTimepoints = {};
                if R.loadTPsflag
                    SPIMTPs = cell(1,numel(R.Frames));
                    
                    for i=reshape(R.Frames,1,[])
        ...
        function SPIMTP = calculateSPIMTimepoints(R,timepoint,varargin)
            SPIMTP = MultiColorSPIMTimepoint(R.pth,R.partitionInfo, timepoint,R.NuclearChannel,'override', true,varargin{:});
        end
