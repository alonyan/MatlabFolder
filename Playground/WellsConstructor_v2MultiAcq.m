function welllbl = WellsConstructor_v2MultiAcq(fpath, acq, Well,frame,NucChannel)
% FF is a structure array - FF.channel, FF.img
    ...
    img = stkread(MD,'Channel',Channels(i), 'flatfieldcorrection', false,'blindflatfield',false, 'frame', frame,'acq',acq, 'Position', Well,'register',false);
...
%    L = imdilate(L,se);
    ...
    %jen wanted voronoi cells
    L = logical(imcomplement(imdilate(voronoiCells.RegionBounds,se)));
